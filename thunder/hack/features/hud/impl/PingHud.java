...
/*    */     
/* 24 */     String str = "Ping " + String.valueOf(class_124.field_1068) + Managers.SERVER.getPing();
/* 25 */     float pX = (getPosX() > mc.method_22683().method_4486() / 2.0F) ? (getPosX() - FontRenderers.getModulesRenderer().getStringWidth(str)) : getPosX();
/*    */     
/* 27 */     if (HudEditor.hudStyle.is(HudEditor.HudStyle.Blurry)) {
/* 28 */       Render2DEngine.drawRoundedBlur(context.method_51448(), pX, getPosY(), FontRenderers.getModulesRenderer().getStringWidth(str) + 21.0F, 13.0F, 3.0F, ((ColorSetting)HudEditor.blurColor.getValue()).getColorObject());
/* 29 */       Render2DEngine.drawRect(context.method_51448(), pX + 14.0F, getPosY() + 2.0F, 0.5F, 8.0F, new Color(1157627903, true));
/*    */       
/* 31 */       Render2DEngine.setupRender();
/* 32 */       RenderSystem.blendFunc(GlStateManager.class_4535.SRC_ALPHA, GlStateManager.class_4534.ONE);
/* 33 */       RenderSystem.setShaderTexture(0, TextureStorage.pingIcon);
...
/* Location:              C:\Users\Егор\Downloads\thunderhack-1.7.jar!\thunder\hack\features\hud\impl\PingHud.class
